...
public class XyNativeModule extends ReactContextBaseJavaModule {
    private static final String LONG_TIME = "LONG";
    private static final String SHORT_TIME = "SHORT";

    public XyNativeModule(ReactApplicationContext reactApplicationContext) {
    ...
    public void show(int duration) {
        Toast.makeText(getReactApplicationContext(), "From RN MSG", duration).show();
    }
